---
title: "Wyvern Pipeline Concept"
description: ""
icon: "pipe-section"
---

A wyvern pipelien defines the end to end flow of the model inference process in your production. It usually is comprised by:

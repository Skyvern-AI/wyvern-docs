...
## Register pipeline and realtime features
Now we go back to the `pipelines/main.py` and register the pipeline and the realtime features with the Wyvern service:
```
from wyvern.service import WyvernService

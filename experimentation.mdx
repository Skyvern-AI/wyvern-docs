...
## Prerequisites
- Install `wyvern-ai >= 0.0.6` or make sure you have it installed.
```
poetry show wyvern-ai
```
...
```
treatment = experimentation_client.get_experiment_result("wyvern-test-feature-flag",

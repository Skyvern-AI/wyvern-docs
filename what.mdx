...
Wyvern starts with solving the Product Ranking use case, as it’s the ML model that brings the biggest impact to a growing marketplace and is usually the most hairy problem that’s hard to solve. Many places builds in-house ML platform to solve the product ranking in the first place.
...
Wyvern indexes your entity catalogs for fast real-time ML inference and connects to your data warehouse.
...
## Wyvern Search & Discovery Architecture

Using Wyvern’s ML Architecture, it’s easy to extend the basic architecture into a search & discovery architecture like this:

<Frame>
  <img class="w-full h-full" src="/images/ranking_architecture.png" />
</Frame>
